		...
		button1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View _view) {
				if (edittext1.getText().toString().equals("") || edittext2.getText().toString().equals("")) {
					SketchwareUtil.showMessage(getApplicationContext(), "Please fill in all required fields");
				}
				else {
					if (edittext3.getText().toString().equals("") || edittext4.getText().toString().equals("")) {
						...
						if (!edittext3.getText().toString().equals(edittext4.getText().toString())) {
							SketchwareUtil.showMessage(getApplicationContext(), "Password do not match, please try again.");
						}
						else {
							SketchwareUtil.showMessage(getApplicationContext(), "Registering ...");
